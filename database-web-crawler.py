...
def scrape_book_info(book_info, category_name):
    ...
    cur.execute("INSERT INTO crawledBooks VALUES (:name , :category , :upc , :url , :imageUrl , :price , :availability , :description )", {
        "name": book_dict["Name"],
        ...
        "availability": book_dict["Availability"],
...
if __name__ == "__main__":
    ...
    cur.execute(f"CREATE TABLE IF NOT EXISTS crawledBooks ({', '.join(header_fields)})")

    crawl_website()
    print("ↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀ \n")
    print(" ⭐⭐⭐ Crawling Done! ⭐⭐⭐ ")

    with open("book_list.csv", "w", encoding="ISO-8859-1") as csvf:

        print("ↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀↀ \n")
        print("Writing on CSV File Started")      
        print(" ██▒▒▒▒▒▒▒▒ [20%] ")
        ...
        cur.execute("SELECT * FROM crawledBooks") 
    ...
    print(" ██████████  [100%] ")
    print("\n ⭐⭐⭐ Done ⭐⭐⭐ ")
    print("CVS File Created with Data And Implemented DATABASE , Web Crawler Done")